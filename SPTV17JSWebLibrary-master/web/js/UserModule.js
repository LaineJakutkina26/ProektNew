        ...
        document.getElementById('content').innerHTML =
            ...
            <div class="card w-50">
                <div class="card-body">
                  ...
                  <p class="card-text d-flex justify-content-end">Purse: <input class="w-50 ml-3" type="text" id="money"></p>
                  ...
                  <p class="card-text d-flex justify-content-end">House: <input class="w-50 ml-3" type="text" id="house"></p>
                  ...
                  <a href="#" id="btnAddUser" class="btn btn-danger w-100 Register user">Register user</a>
                </div>
            </div>
          </div>`;
